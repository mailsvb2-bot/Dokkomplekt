...
class ActionsUiStateMixin:
    ...
    def _on_discharge_date_var_changed(self, *_args) -> None:
        self._mark_manual_field("discharge_date")
        try:
            self._refresh_discharge_date_visual()
        except Exception as exc:
            record_soft_exception("actions_ui_state.discharge_date_visual", exc)
    ...
    def _start_progress(self) -> None:
        ...
        if hasattr(self, "progress"):
            try:
                ...
                record_soft_exception("actions_ui_state:57", exc)
    ...
    def _stop_progress(self) -> None:
        if hasattr(self, "progress"):
            try:
                ...
                record_soft_exception("actions_ui_state:71", exc)
        if hasattr(self, "root"):
