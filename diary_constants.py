...
# Stable settings-folder keys for diary sources.  Kept in the diary domain layer
# so discovery/selection logic does not import app_config/UI styling.
...
# Canonical discharge diary text. Diagnosis templates provide only regular entries.
FINAL_DIARY_TEXT = (
...
GENDER_WORD_PAIRS: tuple[tuple[str, str], ...] = (
    ...
    # Instrumental predicate forms used after «остаётся/является».
    ("вялым", "вялой"),
    ("подавленным", "подавленной"),
    ("пассивным", "пассивной"),
    ("несобранным", "несобранной"),
    ("астенизированным", "астенизированной"),
    ("напряженным", "напряженной"),
    ("напряжённым", "напряженной"),
    ("тревожным", "тревожной"),
    ("подозрительным", "подозрительной"),
    ("замкнутым", "замкнутой"),
    ("спокойным", "спокойной"),
    ("активным", "активной"),
    ("малозаметным", "малозаметной"),
    ("бездеятельным", "бездеятельной"),
    ("монотонным", "монотонной"),
    ("однообразным", "однообразной"),
