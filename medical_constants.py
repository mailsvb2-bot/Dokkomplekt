...
# Stable settings-folder keys live in the domain layer, not in app_config.
# UI can re-export them for backwards compatibility, but non-UI modules should
# import these names from here to avoid coupling storage semantics to colors/window config.
