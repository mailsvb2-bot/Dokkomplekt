...
PRIMARY_MARKERS = [
    ...
    "Профильный статус", "Психический статус", "Соматический статус", "План обследования", "План лечения", "Назначенное лечение",
...
DISCHARGE_MARKERS = [
    ...
    "Жалобы при поступлении", "Анамнез жизни", "Анамнез заболевания", "Профильный статус при поступлении", "Психический статус при поступлении",
...
COMMISSION_MARKERS = [
    ...
    "Анамнез заболевания", "Профильный статус при поступлении", "Психический статус при поступлении", "Соматический статус",
...
VK_MSE_MARKERS = [
    ...
    "Анамнез жизни", "Анамнез заболевания", "Профильный статус при поступлении", "Психический статус при поступлении", "ЭПИ",
...
RVK_MARKERS = [
    ...
    "Анамнез заболевания", "Профильный статус", "Психический статус", "Сомато-неврологический статус", "Результаты обследований",
