...
class MedicalTextParser(
    ...
    FIELD_ALIASES: Dict[str, Sequence[str]] = {
        ...
        "fio": ("Ф.И.О.", "Ф.И.О", "ФИО", "ФИО пациента", "Ф.И.О. пациента", "Ф.И.О пациента", "Фамилия Имя Отчество", "Пациент", "Пациентка", "Больной", "Больная"),
        ...
        "admission": ("Поступает", "Поступил", "Поступила", "Госпитализирован", "Госпитализирована"),
        "doctor": ("Лечащий врач", "Врач", "Врач психиатр", "Врач-психиатр", "Хирург", "Терапевт"),
        "head": ("Заведующий отделением", "Зав. отделением", "Зав. отд.", "Зав отд", "Зав.отделением"),
    }
    ...
    BLOCK_ALIASES: Dict[str, Sequence[str]] = {
        ...
        "mental_status": ("Профильный статус при поступлении", "Профильный статус", "Психический статус при поступлении", "Психический статус"),
        "somatic_status": ("Сомато-неврологический статус", "Соматический статус", "Объективный статус", "Объективно", "Status praesens"),
        "examination_plan": ("План обследования",),
        "treatment_plan": ("План лечения", "Назначенное лечение", "Лечение"),
        "diagnosis": ("Клинический диагноз", "Предварительный диагноз", "Основной диагноз", "Заключительный диагноз", "Диагноз", "был выставлен диагноз", "установлен диагноз", "выставлен диагноз"),
