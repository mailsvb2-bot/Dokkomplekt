...
class MedicalTextParser(
    ...
    BLOCK_ALIASES: Dict[str, Sequence[str]] = {
        ...
        # Generic "Лечение"/"Leczenie"/"Terapia" may describe treatment that
        # has already been performed.  Only explicit plan/assignment headings may
        # populate treatment_plan automatically.
        "treatment_plan": ("План лечения", "Назначенное лечение", "Plan leczenia", "Zalecone leczenie"),
