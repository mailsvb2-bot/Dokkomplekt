...
DEFAULT_FIELD_DEFINITIONS: tuple[FieldDefinition, ...] = (
    ...
    _fd("status.specialty", "Профильный статус", "clinical", ("Профильный статус", "Специальный статус", "Статус при поступлении"), "block"),
    _fd("status.mental", "Психический статус", "clinical", ("Психический статус", "Психический статус при поступлении"), "block"),
    ...
    _fd("examination.plan", "План обследования", "clinical", ("План обследования", "План исследований", "Обследование"), "block"),
    ...
    _fd("epidemiology", "Эпидемиологический анамнез", "clinical", ("Эпидемиологический анамнез", "Эпиданамнез"), "block"),
    _fd("epicrisis.text", "ЭПИ / эпикриз", "clinical", ("ЭПИ", "Эпикриз", "Текст ЭПИ"), "block"),
    _fd("additional.info", "Дополнительная информация", "clinical", ("Дополнительная информация", "Дополнительные сведения"), "block"),
